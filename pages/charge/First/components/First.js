          ...
          <div className={styles.chargeInner}>
            ...
            <div className={styles.firstRowContainer}>
              <div className={styles.inputContainer}>
                <input
                  ...
                  placeholder="비밀번호 입력 후 전용 계좌 확인 버튼을 클릭해주세요."
                ></input>
              </div>
            ...
            <div className={styles.seventhRowContainer}>
              <div className={styles.seventhRowWrapper}>
                ...
                <div className={styles.seventhRowRadioWrapper}>
                  <div>
                    <input type="radio" name="fruit" value={true} /> 동의하며
                    보너스를 받겠습니다.
                  </div>
                  <div>
                    <input type="radio" name="fruit" value={false} /> 아니요
                    기본 이상 하겠습니다.
                  </div>
                </div>
                <div className={styles.seventhRowTextWrapper}>
                  <div className={styles.seventhRowText}>
                    등록된 계좌에서 10분 이내 입금해주셔야합니다.
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className={styles.ninethRowContainer}>
              <div className={styles.ninethRowWrapper}>
                주의사항 <br />
                1. 전용계좌 확인용 비밀번호는 로그인시 비밀번호와 동일합니다.{" "}
                <br />
                2. 입금 전 전용계좌확인은 필수사항으로 전 계좌로 입금시 회사는
                책임지지 않습니다. <br />
                3. 타명의 입금시 충전 승인 불가합니다. 반드시 본인 명의 계좌로
                입금하시기 바랍니다. <br />
                4. 충전 승인이 거절될 경우 쪽지가 발송되오니 확인 후 안내절차에
                따라 진행바랍니다.
                <br />
              </div>
            </div>
